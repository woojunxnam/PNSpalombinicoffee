...
## 네비게이션 드롭다운
모든 42개 HTML 파일에 동일한 헤더가 있음. 헤더 변경 시 **전체 파일에 적용** 필요.

현재 네비 구조:
- About → Technology, Heritage, Reviews, FAQ
- Products → PNS 팔롬비니 상품 라인업, 나만의 드립백 제작, 계열사 상품 라인업, **드립백·패키징 머신 라인업**, 커피 필름지
- B2B → 생산 현장 보기
- Contact
