...
const translations = {
  ko: {
    ...
    'hero-title':    '원두에서 패키지까지,<br/>커피 브랜드를 완성합니다.',
    ...
    'badge-1':'이탈리아 원두','badge-2':'볼케이노 루비','badge-3':'커스텀 드립백','badge-4':'봉투 필름지','badge-5':'패키징 장비','badge-6':'소량 50개~',
    'stat-1':'Caffè Palombini<br/>이탈리아 로마 창업','stat-2':'패키징 장비<br/>라인업','stat-3':'커스텀 드립백<br/>최소 주문 수량','stat-4':'원두 → 드립백 → 필름지 → 장비<br/>올인원 솔루션',
    'about-title':'About Us',
    'about-lead':'PNS 팔롬비니는 단순한 커피 브랜드가 아닙니다.<br>이탈리아 로마 <strong>Caffè Palombini(1946)</strong>의 로스팅 헤리티지와 베트남 화산토에서 자란 <strong>볼케이노 루비 원두</strong>, 그리고 국내 자체 생산 인프라를 결합하여 <strong>원두 수입부터 드립백 OEM, 봉투 필름지, 패키징 장비</strong>까지 — 커피 브랜드가 필요로 하는 모든 것을 하나의 파트너로 제공합니다.',
  ...
  en: {
    ...
    'hero-eyebrow':  'Your Complete Coffee Partner',
    'hero-title':    'From Bean to Package,<br/>We Complete Your Coffee Brand.',
    ...
    'badge-1':'Italian Beans','badge-2':'Volcano Ruby','badge-3':'Custom Drip Bag','badge-4':'Coffee Film','badge-5':'Packaging Machines','badge-6':'Min. 50 Units',
    ...
    'about-title':'About Us',
    'about-lead':'PNS Palombini is more than a coffee brand.<br>Combining the roasting heritage of Rome\'s <strong>Caffè Palombini (1946)</strong> with <strong>Volcano Ruby beans</strong> grown in Vietnamese volcanic soil and domestic production infrastructure — from <strong>bean import to drip bag OEM, coffee film, and packaging machines</strong> — we provide everything a coffee brand needs through a single partner.',
    'tech-title':'Our Technology: The "Inside-Out" Difference',
